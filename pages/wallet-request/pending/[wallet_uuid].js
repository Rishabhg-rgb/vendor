...
const Wallet = ({
	...
	React.useEffect( () => {
		...
		if( wallet_request_data !== null){

			updateState({

				...state,
				wallet_request_amount: wallet_request_data.amount,
				wallet_request_requested_by_name: wallet_request_data.request_added_by.name,
				wallet_request_user_name: wallet_request_data.user_information.name,
				wallet_request_user_mobile: wallet_request_data.user_information.mobile,
	...
	return(
		...
		<>
			<HeadMeta
				title = "Wallet Pending Requests | Shophree"
			/>
			<AlignView>
				<Navigation />
